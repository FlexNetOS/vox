...
fn handle_init() -> Result<()> {
    ...
    // Configure MCP server in Claude Code + Claude Desktop
    ...
    println!("  Claude Code:    {} ({code_status})", code_path.display());
    println!(
        "  Claude Desktop: {} ({desktop_status})",
        desktop_path.display()
    );
    println!();
    println!("Restart Claude Code / Claude Desktop to activate vox voice feedback.");
